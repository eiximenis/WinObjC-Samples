...
+(UITableView*) tableView:(int)x top:(int)y withWidth:(int)w andHeight:(int)h {
...
+(UISegmentedControl*) segmented:(int)x top:(int)y withWidth:(int)w andHeight:(int)h {
    NSArray *itemArray = [NSArray arrayWithObjects: @"Yes", @"No", nil];
    UISegmentedControl* segmentedControl = [[UISegmentedControl alloc] initWithItems:itemArray];
    segmentedControl.frame = CGRectMake(x, y, w, h);
